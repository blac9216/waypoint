...
public sealed class SchemaMigrationTests
{
	...
	public async Task Migrations_ApplyFreshThenReapplyAllViaRunnerAndRawSql_AreAllIdempotent()
	{
		...
		// Four embedded migrations through issue #130: initial schema, running-lease CHECK,
		// the aborted-run queued-job invariant, and the resolved-auth-outcome index -- ExpectedMigrationCount below is
