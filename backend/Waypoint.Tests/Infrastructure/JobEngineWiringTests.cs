...
public sealed class ExecutionCompositionTests
{
	...
	public void RegistersEveryDomainHandler()
	{
		...
		Assert.Equal(
			new HashSet<string>
			{
				"catalog-index", "catalog-pull", "binaries-download", "download", "tool-install", "depot-enrollment", "retention-sweep", "photon-repo-discovery", "photon-image-discovery", "subscription-evaluate", "discover", "scan", "credential-test", "content-pull", "content-check", "purge",
			},
			jobTypes);
	}
