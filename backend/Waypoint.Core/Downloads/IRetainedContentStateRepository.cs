...
public interface IRetainedContentStateRepository
{
	...
	/// <c>policy_id</c> is overwritten and <c>updated_at</c> moves. Issue #1664: this
	/// is NOT the path <c>RetentionSweepService</c>'s landed sweep uses to
	/// re-evaluate an already-tracked artifact against a freshly resolved policy --
