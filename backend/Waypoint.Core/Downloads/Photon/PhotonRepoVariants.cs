...
/// <summary>
/// The Photon RPM repo axis (research #1029 finding 1), matching migration 0108's
...
/// exists in both x86_64 and aarch64 variants"), matching migration 0108's
...
public static class PhotonArches
{
	...
	public static readonly IReadOnlyList<string> All = [X86_64, Aarch64];
}
