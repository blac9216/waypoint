...
/// <summary>Closed <c>ref_type</c> values (migration 0033's CHECK constraint).</summary>
...
/// migration 0033): which upstream ref to track and the commit last actually pulled.
