 ...
 * `runs_run_type_check`, latest as of `0130_photon_lane_index.sql`) minus
 * scan/remediate. `runTypes.test.ts` no longer trusts a hand-copied list here to
 * stay in sync on its own (PR #1759 review: this constant had gone four migrations
 * stale, omitting `binaries-download` and, before that, `depot-enrollment`/
...
export const NON_COMPLIANCE_RUN_TYPES =
	"discover,download,catalog-index,bundle-export,bundle-import,content-library-sync,content-pull,content-import,update,credential-test,tool-install,purge,depot-enrollment,catalog-pull,binaries-download,retention-sweep,photon-repo-discovery,photon-image-discovery,subscription-evaluate";
