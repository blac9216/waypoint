...
[`../ui/prototype/`](../ui/prototype/) — open `vcf-ops-console.dc.html` in a browser; its
...
[`../ui/prototype/README.md`](../ui/prototype/README.md)); its per-screen behavioral specifics
...
Permissions in `../ui/prototype/README.md` — a role that cannot act still sees the
