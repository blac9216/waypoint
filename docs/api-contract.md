...
| Content-library **organize** (folder create/rename/move, item→folder assignment) | — | ✅ | ✅ | `ContentLibraryFoldersController.Create`/`Rename`/`Move`/`AssignItem` (PR #1770, closes #1389/#1746) | ✅ yes — R2-10 names "library upload/organize" as Operator-tier; shipped as Operator+. |
