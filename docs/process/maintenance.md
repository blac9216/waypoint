...
| Shared sequence resources (serialise) | numbered SQL migrations under `backend/Waypoint.Infrastructure/Migrations/` and the schema-ledger test that enumerates them; the `frontend/package-lock.json` |
