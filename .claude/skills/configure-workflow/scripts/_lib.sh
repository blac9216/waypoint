...
# expansion, e.g. ${var,,}, in grant.sh) with a named failure instead of a bare
# parse error on bash 3.2 (still the system /bin/bash on macOS) (#1338). The
# check itself is bash-3-safe: BASH_VERSINFO exists since bash 2.
